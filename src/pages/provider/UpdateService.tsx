  ...
  return (
    <>
      {editing ? (
        ...
        <br />
        <Input placeholder="Input new prices" value={prices} onChange={(e) => setPrices(e.target.value)} />
        <br />
        <Input placeholder="Input new address" value={address} onChange={(e) => setAddress(e.target.value)} />
        <br />
        <Input placeholder="Input new category" value={category} onChange={(e) => setCategory(e.target.value)} />
        <br />
...
//     axios.request({
//       method: "PUT",
//       url: "http://51.104.196.52:8090/api/v1/service/" + serviceId,
//       data: formData
//     }).then((res) => {
//         alert("Update User Successful");
//         //更新成功，然后切换到本来的页面并且刷新数据
